...
dlmwrite('ode10.txt',error);
dlmwrite('ode10.txt',error_l0,'-append');
dlmwrite('ode10.txt',sample,'-append');

dlmwrite('data10.txt',mean(error));
dlmwrite('data10.txt',std(error),'-append');
dlmwrite('data10.txt',mean(error_l0),'-append');
dlmwrite('data10.txt',std(error_l0),'-append');
dlmwrite('data10.txt',mean(sample),'-append');
dlmwrite('data10.txt',std(sample),'-append');
